...
-- Migration v2: ads-manager columns (Facebook rich metrics)
DO $$ BEGIN
  ALTER TABLE creatives ADD COLUMN IF NOT EXISTS status VARCHAR(20) DEFAULT 'no_data';
  ALTER TABLE creatives ADD COLUMN IF NOT EXISTS impressions INT DEFAULT 0;
  ALTER TABLE creatives ADD COLUMN IF NOT EXISTS reach INT DEFAULT 0;
  ALTER TABLE creatives ADD COLUMN IF NOT EXISTS frequency NUMERIC(8,3) DEFAULT 0;
  ALTER TABLE creatives ADD COLUMN IF NOT EXISTS clicks_all INT DEFAULT 0;
  ALTER TABLE creatives ADD COLUMN IF NOT EXISTS cpc_all NUMERIC(10,4) DEFAULT 0;
  ALTER TABLE creatives ADD COLUMN IF NOT EXISTS cpm NUMERIC(10,4) DEFAULT 0;
  ALTER TABLE creatives ADD COLUMN IF NOT EXISTS cpc NUMERIC(10,4) DEFAULT 0;
  ALTER TABLE creatives ADD COLUMN IF NOT EXISTS avg_ticket NUMERIC(10,2) DEFAULT 0;
  ALTER TABLE creatives ADD COLUMN IF NOT EXISTS bounce_rate NUMERIC(6,3) DEFAULT 0;
  ALTER TABLE creatives ADD COLUMN IF NOT EXISTS video_plays INT DEFAULT 0;
  ALTER TABLE creatives ADD COLUMN IF NOT EXISTS video_views INT DEFAULT 0;
  ALTER TABLE creatives ADD COLUMN IF NOT EXISTS video_25 INT DEFAULT 0;
  ALTER TABLE creatives ADD COLUMN IF NOT EXISTS video_50 INT DEFAULT 0;
  ALTER TABLE creatives ADD COLUMN IF NOT EXISTS video_75 INT DEFAULT 0;
  ALTER TABLE creatives ADD COLUMN IF NOT EXISTS video_100 INT DEFAULT 0;
  ALTER TABLE creatives ADD COLUMN IF NOT EXISTS avg_watch_time NUMERIC(8,2) DEFAULT 0;
  ALTER TABLE creatives ADD COLUMN IF NOT EXISTS pixel_purchase INT DEFAULT 0;
  ALTER TABLE creatives ADD COLUMN IF NOT EXISTS play_rate NUMERIC(6,3) DEFAULT 0;
  ALTER TABLE creatives ADD COLUMN IF NOT EXISTS body_rate NUMERIC(6,3) DEFAULT 0;
  ALTER TABLE creatives ADD COLUMN IF NOT EXISTS completion_rate NUMERIC(6,3) DEFAULT 0;
  ALTER TABLE creatives ADD COLUMN IF NOT EXISTS landing_rate NUMERIC(6,3) DEFAULT 0;
  ALTER TABLE creatives ADD COLUMN IF NOT EXISTS checkout_rate NUMERIC(6,3) DEFAULT 0;
  ALTER TABLE creatives ADD COLUMN IF NOT EXISTS cost_per_checkout NUMERIC(10,2) DEFAULT 0;
  ALTER TABLE creatives ADD COLUMN IF NOT EXISTS first_seen TIMESTAMP DEFAULT NOW();
EXCEPTION WHEN OTHERS THEN NULL;
END $$;
