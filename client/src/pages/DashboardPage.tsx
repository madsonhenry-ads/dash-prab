  ...
  return (
    <div className="space-y-4 md:space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-3 md:gap-4">
        ...
        <KpiCard title="Checkouts" value={d.funnel?.checkouts_initiated || 0} type="number" icon="🛒" />
        <KpiCard title="Cost per Checkout" value={(d.funnel?.checkouts_initiated || 0) > 0 ? getSummaryValue(d, 'total_spent') / (d.funnel?.checkouts_initiated || 1) : 0} icon="🧾" />
      </div>
